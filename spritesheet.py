...
# This was taken from https://ehmatthes.github.io/pcc_2e/beyond_pcc/pygame_sprite_sheets/
# this source sourced this from:
...
# Will figure out how to handle this later
import pygame
class SpriteSheet:
